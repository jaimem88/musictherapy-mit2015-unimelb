/************************************************************************************************/
/**** JavaScript for the server side of the webRTC based audio-video conference application****/
/************************************************************************************************/

//Creating a HTTP server and listening for connections
...
//Validating the new user and storing the user details in the server
	...
	socket.on('new user',function(newUser,callback){
		Users.findOne({username:newUser},{contacts:1}).exec( function(err,jsonContacts){
			if(jsonContacts){
